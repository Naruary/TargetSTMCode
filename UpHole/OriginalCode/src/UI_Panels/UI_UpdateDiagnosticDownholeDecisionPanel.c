...
PANEL UpdateDiagnosticDownhole_DecisionPanel =
{ UpdateDiagnosticDownhole_Decision_Menu, sizeof(UpdateDiagnosticDownhole_DecisionMenu) / sizeof(MENU_ITEM), UpdateDiagnosticDownhole_Decision_Paint, UpdateDiagnosticDownhole_Decision_Show,
		UpdateDiagnosticDownhole_Decision_KeyPressed, UpdateDiagnosticDownhole_Decision_TimerElapsed };
