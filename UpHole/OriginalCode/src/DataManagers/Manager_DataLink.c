 ...
 ****************************************************************************/
static ANGLE_TIMES_TEN limit_angle(ANGLE_TIMES_TEN raw_data, ANGLE_TIMES_TEN lowest, ANGLE_TIMES_TEN highest)
{
	ANGLE_TIMES_TEN output;
	output = raw_data;
	while (output < lowest)
		output += THREE_SIXTY_TIMES_TEN;
	while (output >= highest)
		output -= THREE_SIXTY_TIMES_TEN;
	return output;
}
